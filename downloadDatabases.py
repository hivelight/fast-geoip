...
urllib.request.urlretrieve ("https://download.maxmind.com/geoip/databases/GeoLite2-City-CSV/download?suffix=zip&license_key=" + os.environ["MAXMIND_LICENSE_KEY"], ZIP_FILENAME)
